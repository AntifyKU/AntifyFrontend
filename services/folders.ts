...
export async function getFolders(token: string): Promise<FolderListResponse> {
  return apiClient.get<FolderListResponse>("/api/users/me/folders", {
    authToken: token,
  });
}
...
export async function createFolder(
  ...
  return apiClient.post<Folder>("/api/users/me/folders", data, {
    authToken: token,
  });
}
...
export async function updateFolder(
  ...
  return apiClient.put<Folder>(`/api/users/me/folders/${folderId}`, data, {
    authToken: token,
  });
}
